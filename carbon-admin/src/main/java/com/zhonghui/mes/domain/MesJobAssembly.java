...
/**
 * 制造执行MES-生产作业对象 mes_job_assembly
 * 
 * @author yang
 * @date 2024-04-10
 */
public class MesJobAssembly extends BaseEntity
{
    ...
    /** 制造执行MES-生产作业明细信息 */
    private List<MesJobAssemblyItem> mesJobAssemblyItemList;
    ...
    public List<MesJobAssemblyItem> getMesJobAssemblyItemList()
    {
        return mesJobAssemblyItemList;
    }

    public void setMesJobAssemblyItemList(List<MesJobAssemblyItem> mesJobAssemblyItemList)
    {
        this.mesJobAssemblyItemList = mesJobAssemblyItemList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("mesJobAssemblyItemList", getMesJobAssemblyItemList())
            .toString();
    }
}
